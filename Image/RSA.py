...
def Decrypt():
    global i, j, Y
    Y = []
    print("Enter encoded file name: ")
    encoded_image_file = input()
...
def Encrypt():
    ...
    print("Enter name of file to be encoded: ")
...
while mm != 'quit':
    ...
    if mm.lower() == 'encrypt':
        ...
        if mm != 'quit':
            ...
            statements = ["This cannot be done", "Read the directions again", "Didn't say the magic word",
                          "This input is UNACCEPTABLE!!", "Was that even a word???", "Please follow the directions",
